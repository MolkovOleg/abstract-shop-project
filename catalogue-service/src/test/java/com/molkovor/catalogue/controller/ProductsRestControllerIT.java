...
class ProductsRestControllerIT {
    ...
    void getAllProducts_ReturnsListOfProducts() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        content().json("""
                                [
                                    {"id": 2, "title": "Шоколад", "details": "Темный шоколад"}
                                ]
                                """)
                );
    }
    ...
    @Test
    @Sql("/sql/products.sql")
    void getAllProducts_UserIsUnauthorized_ReturnsListOfProducts() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalogue-api/products")
                .param("filter", "шок")
                .with(jwt());
    ...
    @Test
    void createProduct_RequestIsInvalid_ReturnsErrorsProblemDetail() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.post("/catalogue-api/products")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
