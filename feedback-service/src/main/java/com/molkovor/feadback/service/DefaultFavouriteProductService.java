...
import com.molkovor.feadback.repository.FavouriteProductRepository;
...
public class DefaultFavouriteProductService implements FavouriteProductService {
    ...
    public Mono<FavouriteProduct> addProductToFavourites(int productId, String userId) {
        return favouriteProductRepository.save(
    ...
    @Override
    public Mono<FavouriteProduct> findFavouriteProductByProductIdAndUserId(int productId, String userId) {
